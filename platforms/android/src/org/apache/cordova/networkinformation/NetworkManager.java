...
public class NetworkManager extends CordovaPlugin {
    ...
    private void checkNetWrokState() {
        final Handler handler = new Handler() {
            @Override
            public void handleMessage(Message msg) {
                PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, msg.obj.toString());
                pluginResult.setKeepCallback(true);
                statusCallbackContext.sendPluginResult(pluginResult);
            }
        };
