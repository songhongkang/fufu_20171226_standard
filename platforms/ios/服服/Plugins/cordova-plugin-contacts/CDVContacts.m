...
@interface CDVContacts() <CDVAlertMessageViewDelegate>
...
- (void)search:(CDVInvokedUrlCommand*)command
{
    ...
    if (authStatus == kABAuthorizationStatusDenied || authStatus == kABAuthorizationStatusRestricted) {
        ...
        CDVAlertMessageView *message = [[CDVAlertMessageView alloc] initWithTitle:@"允许访问通讯录" message: @"进入系统【设置】>【隐私】>【通讯录】中打开开关，并允许服服访问通讯录" okButtonTitle:@"立即开启" textType:TextLeft delegate:self];
