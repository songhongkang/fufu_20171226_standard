...
{
    _realCallbackId = command.callbackId;
//    Boolean isRealConnection = [[CheckNetStatusWithTcp alloc] TryCheckNetCanUse];
    CDVPluginResult* result = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsBool:YES];
    [result setKeepCallbackAsBool:YES];
    [self.commandDelegate sendPluginResult:result callbackId:_realCallbackId];
}
