...
@interface CDVCamera () <CDVAlertMessageViewDelegate>
...
//                        CDVAlertMessageView *message = [[CDVAlertMessageView alloc] initWithTitle:@"允许访问照片" message: @"进入系统【设置】>【隐私】>【照片】中打开开关，并允许服服访问照片" okButtonTitle:@"立即开启" delegate:weakSelf];
                        CDVAlertMessageView *message = [[CDVAlertMessageView alloc] initWithTitle:@"允许访问照片" message:@"进入系统【设置】>【隐私】>【照片】中打开开关，并允许服服访问照片" okButtonTitle:@"立即开启" textType:TextLeft delegate:weakSelf];
...
//                                                message:@"请您设置允许\"服服\"访问您的相机\n设置>隐私>相机"
//                                               delegate:weakSelf
//                                      cancelButtonTitle:@"确定"
//                                      otherButtonTitles:nil, nil] show];
                    
                    
                    CDVAlertMessageView *message = [[CDVAlertMessageView alloc] initWithTitle:@"允许访问相机" message: @"进入系统【设置】>【隐私】>【相机】中打开开关，并允许服服访问相机" okButtonTitle:@"立即开启" textType:TextLeft delegate:weakSelf];
                    [message showInView:cameraPicker.view];
