...
- (instancetype)init{
    return [self initWithAnimateType:animate_push andDuration:2.0f];
}
...
//    NSLog(@"push==========");
    ...
    ImageBrowseViewController *toVC   = (ImageBrowseViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
//    NSLog(@"pop==========");
    ...
    ImageBrowseViewController *fromVC = (ImageBrowseViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
