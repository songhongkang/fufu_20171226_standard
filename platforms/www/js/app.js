    ...
    success : function(data, status, headers, config) {
      try {
        ...
        if(angular.isDefined(_data.roster_data)&&_data.roster_data!=""&&_data.roster_data.flag==1){
          window.localStorage.roster_card_data = JSON.stringify(_data.roster_data.card_date);
          ...
          window.localStorage.roster_card_data = '{"flag": 0,"card_date": [],"sn": ""}';
        }
...
angular.module('citymobi', ['ionic', 'citymobi.services', 'citymobi.controllers','citymobi.directives','citymobi.filters'])
  .run(function($ionicPlatform,$rootScope,$ionicLoading,$ionicPopup,$location,$ionicHistory,$ionicScrollDelegate,$ionicViewSwitcher,atMbIndoorSettingDetailSev,
                ...
                menulistService,payrollCalSev,atAnalySev,autoRosSev,attendanceDeviceSev) {
    ...
    $ionicPlatform.ready(function() {
      ...
      if (window.cordova && window.cordova.plugins && window.cordova.plugins.Keyboard) {
        ...
        document.addEventListener("jpush.receiveMessage", function(data) {
          ...
          var 
            attendanceDeviceURL = "/home_page/home_default/attendance_device",
            isAtDeViews = $ionicHistory.currentView().url.indexOf(attendanceDeviceURL);

          if(isAtDeViews == 0&&angular.isDefined(_data.payload)&&_data.payload!=null){
  ...
  .config(function($stateProvider,$urlRouterProvider,$ionicConfigProvider,$httpProvider) {
    ...
    $stateProvider
      ...
      .state('home_page.attendance_device', {
        url: '/home_default/attendance_device/:device_sn/:device_name',
        cache:true,
        views: {
          'home-default-nav': {
